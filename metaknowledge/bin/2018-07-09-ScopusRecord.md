...
<a name="ScopusRecord.__init__"></a><small></small>**[<ins>ScopusRecord.__init__</ins>]({{ site.baseurl }}{{ page.url }}#ScopusRecord.__init__)**(_inRecord, sFile='', sLine=0, header=None_):
...
<a name="createCitation"></a><small>ScopusRecord.</small>**[<ins>createCitation</ins>]({{ site.baseurl }}{{ page.url }}#createCitation)**(_multiCite=False_):
